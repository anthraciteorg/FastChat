...
Users by clicking "Send" agree to the following terms of the service:

The service only provides limited safety measures and may generate offensive content.  
We, Anthracite, do not take responsibility of the outputs generated by the models hosted.  
Please do not upload any private information. The service collects user dialogue data, and reserves the right to distribute it under any license Anthracite sees fit.

#### Please report any bug or issue on the [GitHub Issue Tracker](https://github.com/anthraciteorg/FastChat/issues)  

### Acknowledgment
We thank [LMSYS](https://lmsys.org/) for their development of FastChat/The Arena
"""
...
def build_about():
    about_markdown = """
# About Us
Anthracite Arena is based on the Chatbot Arena by members from [LMSYS](https://lmsys.org) and UC Berkeley [SkyLab](https://sky.cs.berkeley.edu/).

## Contact Us
- Follow us on [X](https://x.com/anthraciteorg)
- File issues on [GitHub](https://github.com/anthraciteorg/FastChat/issues)
- Download our released models on [HuggingFace](https://huggingface.co/anthracite-org)
