...
() => {
    if (window.alerted_before) return;
    const msg = "Users of this website are required to agree to the following terms:\\n\\nThe service only provides limited safety measures and may generate offensive content. We, Anthracite, do not take responsibility of the outputs generated by the models hosted. Please do not upload any private information. The service collects user dialogue data, and reserves the right to distribute it under any license Anthracite sees fit.";
    alert(msg);
    window.alerted_before = true;
}
"""
